                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <button wire:click="editTarea({{ $tarea['id'] }})"
                                            class="inline-flex items-center p-1.5 text-blue-600 hover:text-blue-800 dark:text-blue-400 cursor-pointer"
                                            title="Editar tarea">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button wire:click="openDeleteTareaModal({{ $tarea['id'] }})"
                                            class="inline-flex items-center p-1.5 text-red-600 hover:text-red-800 dark:text-red-400 cursor-pointer"
